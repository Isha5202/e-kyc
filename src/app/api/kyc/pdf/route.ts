  ...
  <head>
    ...
    <style>
      * { box-sizing: border-box; }
      ...
      h1 { text-align: center; color: #2c3e50; font-size: 26px; margin-bottom: 30px; border-bottom: 2px solid #eee; padding-bottom: 10px; }
      h3 { text-align: center; }
      table { width: 100%; border-collapse: collapse; }
      td { padding: 12px 16px; border-bottom: 1px solid #eaeaea; vertical-align: top; font-size: 14px; }
      td.label { background: #f1f3f5; font-weight: 600; width: 30%; color: #333; }
      ...
      <div class="container">
        ...
        <div class="signature-section">
          <div class="signature-block">
            <div style="font-weight: bold; margin-top: 80px;">(Signature of the Authorised Signatory)</div>
          </div>
          <div class="signature-block">
            <div style="font-weight: bold; margin-top: 80px;">(Signature of the Branch Manager)</div>
          </div>
        </div> 
