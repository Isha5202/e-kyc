...
export function Settings(props: PropsType) {
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M19.43 12.98c.04-.32.07-.66.07-1s-.03-.68-.07-1l2.11-1.65a.5.5 0 00.11-.65l-2-3.46a.5.5 0 00-.61-.22l-2.49 1a8.36 8.36 0 00-1.7-.98l-.38-2.65A.5.5 0 0014 2h-4a.5.5 0 00-.5.43l-.38 2.65c-.63.27-1.2.6-1.7.98l-2.49-1a.5.5 0 00-.61.22l-2 3.46a.5.5 0 00.11.65L4.57 11c-.04.32-.07.66-.07 1s.03.68.07 1L2.46 14.65a.5.5 0 00-.11.65l2 3.46a.5.5 0 00.61.22l2.49-1c.5.38 1.07.71 1.7.98l.38 2.65a.5.5 0 00.5.43h4a.5.5 0 00.5-.43l.38-2.65c.63-.27 1.2-.6 1.7-.98l2.49 1a.5.5 0 00.61-.22l2-3.46a.5.5 0 00-.11-.65l-2.11-1.67zM12 15.5A3.5 3.5 0 1115.5 12 3.5 3.5 0 0112 15.5z"
      />
    </svg>
  );
}
...
export function UserManagementIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={24}
...
export function APIKeyIcon(props: PropsType) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={24}
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M12 1.75a6.25 6.25 0 100 12.5c.165 0 .328-.007.49-.02l1.336 1.337v.683a.75.75 0 001.5 0v-.683l.683-.683h.683a.75.75 0 000-1.5h-.683l-1.337-1.336c.013-.163.02-.326.02-.491A6.25 6.25 0 0012 1.75zM3.25 8a8.75 8.75 0 1116.442 5.093l1.108 1.107a2.25 2.25 0 01-3.182 3.183l-.17-.17-.65.65v.207a2.25 2.25 0 11-4.5 0v-.207l-.65-.65-.17.17a2.25 2.25 0 11-3.182-3.182l1.107-1.108A8.715 8.715 0 013.25 8z"
        fill="currentColor"
      />
    </svg>
  );
...
export function BalanceIcon(props: PropsType) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={24}
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M12 1.25a.75.75 0 01.75.75v1h6a.75.75 0 01.75.75v2.535a3.25 3.25 0 11-1.5 0V4.75h-5.25v14.5H16a.75.75 0 010 1.5h-4v2.25a.75.75 0 01-1.5 0V20.75H6a.75.75 0 010-1.5h3.25V4.75H4.5v1.535a3.25 3.25 0 11-1.5 0V2.75a.75.75 0 01.75-.75h6v-1A.75.75 0 0112 1.25zM4 8.25a1.75 1.75 0 100-3.5 1.75 1.75 0 000 3.5zm16 0a1.75 1.75 0 100-3.5 1.75 1.75 0 000 3.5z"
        fill="currentColor"
      />
    </svg>
  );
